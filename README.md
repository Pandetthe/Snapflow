...
[![Server CI](https://img.shields.io/github/actions/workflow/status/Pandetthe/Snapflow/server-ci.yml?label=Server%20CI&style=flat-square&logo=dotnet)](https://github.com/Pandetthe/Snapflow/actions/workflows/server-ci.yml)
[![Web CI](https://img.shields.io/github/actions/workflow/status/Pandetthe/Snapflow/web-ci.yml?label=Web%20CI&style=flat-square&logo=svelte)](https://github.com/Pandetthe/Snapflow/actions/workflows/web-ci.yml)
[![Publish](https://img.shields.io/github/actions/workflow/status/Pandetthe/Snapflow/publish.yml?label=Publish&style=flat-square&logo=githubactions)](https://github.com/Pandetthe/Snapflow/actions/workflows/publish.yml)
