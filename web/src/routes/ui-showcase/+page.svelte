    ...
    <div class="grid grid-cols-1 gap-12">
      ...
      <section class="space-y-8">
        ...
        >
          <div class="space-y-8">
            <div>
              <h3 class="mb-5 text-sm font-bold tracking-widest text-gray-400 uppercase">
                Variants
              </h3>
              <div class="space-y-6">
      ...
      <section class="space-y-8">
        ...
        <div
          class="flex flex-wrap gap-8 rounded-xl border border-gray-100 p-6 dark:border-gray-800"
        >
          <BoardCard title="Scenography board" id="scenography" class="w-70" />
          <BoardCard title="Project Alpha" id="project-alpha" class="w-70" />
          <BoardCard title="Marketing Team" id="marketing-team" class="w-70" />
        </div>
      </section>
    </div>
  </div>
