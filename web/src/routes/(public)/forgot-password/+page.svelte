<script lang="ts">
  ...
  import { apiClient } from '$lib/core/api.client.ts';
  ...
  const forgotPasswordInfoMessage =
    'If an account exists for the provided email, you will receive an email with instructions to reset your password shortly. Please check your inbox and spam folder.';
