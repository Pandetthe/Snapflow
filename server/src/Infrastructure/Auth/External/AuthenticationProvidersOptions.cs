...
public sealed partial class AuthenticationProvidersOptions : IValidatableObject
{
    ...
    private static readonly string[] ReservedSchemes = ["Google", "Microsoft", "Facebook", "GitHub", "Saml2", "Ldap", "callback"];
    ...
    {
        int redirectProviders = new[] { Google.Enabled, Microsoft.Enabled, Facebook.Enabled, GitHub.Enabled, Saml.Enabled }.Count(enabled => enabled)
