...
public interface IBoardHubClient
{
    ...
    public sealed record BoardVisibilityChangedPayload(BoardVisibility Visibility);

    Task BoardVisibilityChanged(BoardVisibilityChangedPayload payload, CancellationToken cancellationToken = default);
