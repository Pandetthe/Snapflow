...
internal sealed class ChangeBoardMemberRoleCommandValidator : AbstractValidator<ChangeBoardMemberRoleCommand>
{
    public ChangeBoardMemberRoleCommandValidator()
    {
        RuleFor(c => c.UserId)
