...
internal sealed class MoveSwimlaneCommandHandler(
    IAppDbContext dbContext,
    IUserContext userContext,
    TimeProvider timeProvider,
    IEntityRankService<Swimlane> rankService) : ICommandHandler<MoveSwimlaneCommand>
{
    public async Task<Result> Handle(MoveSwimlaneCommand command, CancellationToken cancellationToken = default)
    {
